...
export { HTTP, REG_URI_DOMAIN, REG_URI_PATH, REG_URI_PORT, REG_URI_PROTOCOL, Store, copy, deepClone, is, isArray, isBaseType, isBigInt, isBoolean, isDate, isDom, isFunction, isNull, isNumber, isObject, isPromise, isRegExp, isString, isSymbol, isUndefined, mapListToObject, parseURL, random };
